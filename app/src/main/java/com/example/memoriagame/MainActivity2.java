...
public class MainActivity2 extends AppCompatActivity {
    ...
    private ImageButton img1, img2, img3,img4 , tem1 , tem2 , img5, img6;

    private String[] fotos = {"android","apple","apple","android","huawei","huawei"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img5 = (ImageButton)findViewById(R.id.id_image5);
        img6 = (ImageButton)findViewById(R.id.id_image6);
